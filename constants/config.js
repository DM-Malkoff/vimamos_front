...
export const colors = [
    ...
    { name: 'мульти', code: '#334835', slug: 'multi' },
    ...
    { name: 'чёрный', code: '#000000', slug: 'chyornyj' }
];
